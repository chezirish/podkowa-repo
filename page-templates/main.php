...
<section class="section section-info">
    <div class="section-content info">
        <h1>Co nie co o kawie</h1>
        <p>Zawsze kiedy masz zamiar napić się kawy, powinieneś pamiętać, że każdy łyk to akumulacja
        tysięcy mil podróży, wielu lat doświadczeń, ciężkiej pracy i pasji. Oto jak powstaje dla
        przygotowana specjalnie dla Ciebie nasza rzemieślnicza kawa. </p>
...
<section class="section section-info4 "  style="background-image:url(<?= get_template_directory_uri() ?>/dist/assets/images/1/Page-1-Image-6.png);background-size:cover;background-position:center">
    <div class="section-content info">
        ...
        w filiżance, aby nasi klienci mogli z radością pić każdą filiżankę.
